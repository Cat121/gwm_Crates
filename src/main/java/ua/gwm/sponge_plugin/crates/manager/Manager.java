...
public class Manager {
    ...
    public Manager(ConfigurationNode node) {
        ...
        for (ConfigurationNode drop_node : drops_node.getChildrenMap().entrySet().stream().
    ...
    public Manager(String name, Case caze, Key key, Set<Drop> drops, OpenManager open_manager) {
        this.name = name;
        this.caze = caze;
        this.key = key;
        this.drops = drops;
